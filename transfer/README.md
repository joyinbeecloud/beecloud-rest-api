...
optional | Map | 附加数据 | 用户自定义的参数，将会在Webhook通知中原样返回，该字段主要用于商户携带订单的自定义数据 | {"email","xiaoming123@126.com","key1":"value1","key2":"value2",...} ，其中用户必须要填写在beecloud注册的email，不填或者填错将导致代付失败| 是
